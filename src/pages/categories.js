...
export default function categories() {
    const [category, setCategory] = useState({ quantity: 0, type: 0, difficulty: "" });
    ...
    return (
        <div className='h-[900px] bg-[#021622] flex-c-center'>
            <div className='text-white w-[23%] flex-c-center border-0 border-gray-700 rounded p-8'>
                <p className='text-[35px] font-semibold w-[100%] text-center mb-16'>Categories</p>
                ...
                <div className='flex flex-col justify-start my-16 w-[100%]'>
                    <button className='green-btn w-[100%]' onClick={() => {
                        if (category.type && category.quantity && category.difficulty) {
                            router.push({
                                pathname: "/quiz",
                                query: category
                            })
